...
lv_font_t ${f.font_name} = {
    ...
    .line_height = ${f.src.typoAscent - f.src.typoDescent}, /*The maximum line height required by the font*/
    .base_line = ${-f.src.typoDescent},                     /*Baseline measured from the bottom of the line*/
